...
export const RootContainer = styled("div")`
  ...
  padding: 16px;
  background: ${(props: any) => theme.defaultTheme?.palette?.grokList?.grokBg};
...
export const ZoneContainer = styled("div")`
  ...
  background-color: ${(props: any) =>
    theme.defaultTheme?.palette?.grokList?.zoneContainerBackground};
  margin-bottom: 20px;
  border-radius: 3px;
...
export const ZoneHeader = styled("div")`
  ...
  background-color: ${(props: any) =>
    theme.defaultTheme?.palette?.grokList?.zoneHeaderBackground};
  padding: 10px 20px;
  display: flex;
  align-items: center;
...
export const InstrumentContainer = styled("div")`
  ...
  //   width: calc(100% - 24px);
  margin-bottom: 10px;
  background-color: ${theme.defaultTheme.palette.grokList
    .instrumentExpandedBackground};
...
export const InstrumentHeader = styled("div")<{ highlighted?: boolean }>`
  border-radius: 3px 3px 0px 0px;
  background-color: ${theme.defaultTheme.palette.grokList
    .instrumentCollapsedBackground};
  color: ${({ highlighted }) =>
    highlighted
      ? theme.defaultTheme.palette.grokList.highlightedFontColor
      : theme.defaultTheme.palette.grokList.defaultFontColor};
  padding: 12px 16px;
  display: flex;
  align-items: center;
  cursor: pointer;
